<!-- Original upstream README; relative commands assume the repository root. -->
...
2. Build Docker containers with algorithms of interest (e.g., listed in examples/mission1_experiments.py) using instruction from README in the TimeEval-algorithms folder. 
...
- Mission1: examples/mission1_experiments.py
- Mission2: examples/mission2_experiments.py
