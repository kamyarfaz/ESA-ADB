...
Usage:
    python -m esa_thesis representatives
    python -m esa_thesis representatives --corr_csv results_longrun/channel_correlation/channel_correlation_matrix.csv
    python -m esa_thesis representatives --cut 0.30 --min_size 3 --per_cluster 2
"""
...
def main():
    ...
    ap.add_argument("--corr_csv",
                    default=(str(project_path('results_longrun/channel_correlation/channel_correlation_matrix.csv'))))
    ...
    ap.add_argument("--out_csv", default=str(project_path("results_longrun/channel_correlation/cluster_representatives.csv")))
    args = ap.parse_args()
