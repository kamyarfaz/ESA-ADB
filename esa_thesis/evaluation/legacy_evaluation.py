...
Usage:
    python -m esa_thesis evaluate
    python -m esa_thesis evaluate --results_root results_longrun/mission1_reconstruction_ae_sweep_optimized/20260519_155620
    python -m esa_thesis evaluate --top 10
"""
