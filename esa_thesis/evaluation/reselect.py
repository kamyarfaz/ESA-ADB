...
Usage:
    python -m esa_thesis reselect
    python -m esa_thesis reselect --root results_longrun/mission1_reconstruction_ae_sweep_optimized/20260519_155620
    python -m esa_thesis reselect --protocol best_val_esa_f05_val_pred_rate_lte_0.01
"""
