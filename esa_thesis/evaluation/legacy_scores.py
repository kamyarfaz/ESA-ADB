...
Usage:
    python -m esa_thesis score
    python -m esa_thesis score --root results_longrun/mission1_reconstruction_ae_sweep_optimized/20260519_155620
    python -m esa_thesis score --split val      # only validation
    python -m esa_thesis score --split test     # only test
"""
